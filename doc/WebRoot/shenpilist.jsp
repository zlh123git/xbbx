...
<script type="text/javascript">
	...
	$(function(){
		...
		function yes(id){
			window.location.href="<%=path %>/updatecgstatus.action?cgid="+id+"&&status=yes";
		}
		function no(id){
			window.location.href="<%=path %>/updatecgstatus.action?cgid="+id+"&&status=no";
		}
		function cgadd(){
          ...
          <tr>
            <td><%=bean.getId() %></td>
             ...
             <td><%=bean.getStatus() %></td>
              <td> <a onclick="yes(<%=bean.getId()%>)">通过</a>
              	<a onclick="no(<%=bean.getId()%>)">驳回</a>
              </td>
          </tr>
          <%} %>
          <%} %>
