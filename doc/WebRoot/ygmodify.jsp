...
<body>
 <form method="post" action="<%=path %>/ygmodify.action" method="post" name="ThisForm">
 <input id="id" name="id" type="hidden" value="<%=bean.getId() %>">
<div id="contentWrap">
	<!--表格控件 -->
  <div id="widget table-widget">
    <div class="pageTitle">员工修改</div>
    <div class="pageColumn">
      ...
      <table>
          ...
          <option value="<%=bean.getRealname() %>"><%=bean.getRealname() %></option>
          	<option value="工种1">工种1</option>
          <option value="工种2">工种2</option>
          </select>
          </th>
            </thead>
             <thead>
